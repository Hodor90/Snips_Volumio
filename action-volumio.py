...
class Volumio():
    ...
    def __init__(self):
        ...
        self.base_api_url = "http://{0}:{1}/api/v1/commands/?cmd=".format(self.config['global']['host'], self.config['global']['port'])
    ...
    def start_blocking(self):
        ...
        mqtt_opts = MqttOptions(username=self.config['secret']['mqtt_user'], password=self.config['secret']['mqtt_pw'], broker_address=mqtt_addr)
